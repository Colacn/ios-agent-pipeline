...
2. **Layering authority**：本 Skill **附录 A** 为通用占位；**已安装 project overlay** 时以应用仓 `project-overlays/<name>/appendix-a-layers.md` 为准。详见 [`../../references/guide/layering.md`](../../references/guide/layering.md)。
3. **编码与协作**：见 [`../develop/SKILL.md`](../develop/SKILL.md) Appendix；overlay 见 [`../../templates/overlay/README.md`](../../templates/overlay/README.md)。
...
读取应用仓根 `project-overlays/<name>/appendix-a-layers.md`（由应用仓维护）。脚手架：[`../../templates/overlay/sample/`](../../templates/overlay/sample/)。
