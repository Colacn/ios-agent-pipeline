...
```bash
git clone https://github.com/lixiuwei/ios-agent-pipeline.git /tmp/ios-agent-pipeline
...
```bash
npx skills add lixiuwei/ios-agent-pipeline@analyze
npx skills add lixiuwei/ios-agent-pipeline@plan
```
